...
exports.moderatorAddedEmailTemplate = exports.projectCreateAndPaymentConfirmationEmailTemplate = exports.projectInfoEmailTemplate = exports.resetPasswordEmailTemplate = exports.verificationEmailTemplate = void 0;
...
const verificationEmailTemplate = (name, token) => `
  ...
  <p><a href="${index_1.default.frontend_base_url}/verify-email?token=${token}">Verify Your Account</a></p>
...
const projectInfoEmailTemplate = ({ user, formData, formattedSessions, }) => {
    var _a;
    return `
  ...
  <p><strong>Add-Ons:</strong> ${(_a = formData.addOns) === null || _a === void 0 ? void 0 : _a.join(", ")}</p>
...
exports.projectInfoEmailTemplate = projectInfoEmailTemplate;
const projectCreateAndPaymentConfirmationEmailTemplate = ({ firstName, purchaseAmount, creditsPurchased, transactionDate, newCreditBalance, }) => `
  ...
  <p>The Amplify Team</p>
`;
exports.projectCreateAndPaymentConfirmationEmailTemplate = projectCreateAndPaymentConfirmationEmailTemplate;
const moderatorAddedEmailTemplate = ({ moderatorName, addedByName, projectName, loginUrl, }) => `
...
`;
exports.moderatorAddedEmailTemplate = moderatorAddedEmailTemplate;
